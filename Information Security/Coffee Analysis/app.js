...
(function() {
  var alphabetFreq, body, ch, charArray, chars, charsCount, decRow, encRow, i, table, text, _i, _ref, _ref1;
  ...
  for (i = _i = 0, _ref1 = charArray.length - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
